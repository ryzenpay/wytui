...
<svelte:head>
	<title>API Documentation - wytui</title>
</svelte:head>
...
<style>
	...
	:global(.swagger-ui .response-col_description__inner p),
	:global(.swagger-ui table thead tr th),
	:global(.swagger-ui table thead tr td),
