...
export const POST = apiRoute('/api/watch-progress/[downloadId]/watched', 'POST', {
	...
	body: {
		watched: { type: 'boolean', required: true, description: 'Whether to mark as watched (true) or unwatched (false)' },
	},
	responses: {
		200: {
