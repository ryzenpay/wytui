...
export const POST = apiRoute('/api/import', 'POST', {
	...
	auth: 'admin',
	body: {
		files: { type: 'array', required: true, description: 'Array of files to import with filepath and optional videoId' },
		profileId: { type: 'string', required: true, description: 'Download profile ID to associate with imported files' },
	},
	responses: {
		200: {
