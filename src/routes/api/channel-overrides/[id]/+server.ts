...
export const PATCH = apiRoute('/api/channel-overrides/[id]', 'PATCH', {
	...
	try {
		...
		const allowedFields = ['channelUrl', 'channelName', 'profileId', 'autoDeleteDays', 'sponsorblock', 'customFlags'];
...
export const DELETE = apiRoute('/api/channel-overrides/[id]', 'DELETE', {
