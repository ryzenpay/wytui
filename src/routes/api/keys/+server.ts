...
export const GET = apiRoute('/api/keys', 'GET', {
...
export const POST = apiRoute('/api/keys', 'POST', {
	...
	responses: {
		201: {
			...
			schema: {
				...
				properties: {
					id: { type: 'string' },
					key: { type: 'string', description: 'The full API key — store this, it will not be shown again' },
