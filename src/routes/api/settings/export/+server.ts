...
import { ALLOWED_SETTINGS_FIELDS } from '$lib/server/services/settings-validation';
import type { RequestHandler } from './$types';

export const GET = apiRoute('/api/settings/export', 'GET', {
	summary: 'Export application settings as YAML',
	description: 'Admin-only. Downloads the full settings config as a YAML file, including secret values in plaintext (API keys, tokens, passwords) — store the file securely.',
	tags: ['Settings'],
	auth: 'admin',
	responses: {
		200: {
