...
export const GET = apiRoute('/api/preferences', 'GET', {
	summary: 'Get download preferences for the current user',
	description: 'Returns all saved preference sets keyed by mode (video_library, video_cache, audio_library, audio_cache)',
	tags: ['Preferences'],
	auth: true,
	responses: {
		200: {
...
export const PUT = apiRoute('/api/preferences', 'PUT', {
	summary: 'Save download preferences for a mode',
	description: 'Upserts preferences for a specific mode (video_library, video_cache, audio_library, audio_cache)',
	tags: ['Preferences'],
	auth: true,
	body: {
